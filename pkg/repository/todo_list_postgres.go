...
func (r *TodoListPostgres) Create(userId int, list testRestApi.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoListPostgres) GetAll(userId int) ([]testRestApi.TodoList, error) {
	var lists []testRestApi.TodoList
...
func (r *TodoListPostgres) GetById(userId, listId int) (testRestApi.TodoList, error) {
	var list testRestApi.TodoList
...
func (r *TodoListPostgres) Update(userId, listId int, input testRestApi.UpdateListInput) error {
